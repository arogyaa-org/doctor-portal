...
export function Layout({
  ...
  const isDoctorSignup =
    typeof pathname === "string" && pathname.includes("/signup-as-doctor");
  ...
  return (
    <Box
      sx={{
        ...
        gridTemplateColumns: isDoctorSignup ? "1fr" : "1fr 1fr",
        minHeight: "100%",
      }}
    >
      ...
      >
        ...
        >
          ...
          >
            © 2025 Arogyaa Health Systems. All rights reserved.
          </Typography>
        </Box>
      </Box>
