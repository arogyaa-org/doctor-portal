        ...
        <>
          ...
          <Grid container spacing={0.5} sx={{ marginTop: -0.5 }}>
            {[
              ...
              {
                icon: <BloodDropIcon color="error" />,
                label: "Blood Group",
                value: "B+",
              },
            ].map((detail, index) => (
        ...
        <div>
          ...
          <Grid container spacing={2}>
            {[
              ...
              { test: "X-Ray", result: "Clear" },
              { test: "MRI", result: "No issues detected" },
              { test: "Ultrasound", result: "Healthy organs" },
              { test: "CT Scan", result: "No anomalies detected" },
              { test: "ECG", result: "Normal heart rhythm" },
            ].map((report, index) => (
        ...
        <div>
          ...
          <Grid container spacing={2}>
            {[
              {
                name: "Medication A",
                description: "Daily dosage",
                icon: <PrescriptionIcon color="secondary" />,
              },
              {
                name: "Therapy B",
              ...
              {
                name: "Physiotherapy",
                description: "Bi-weekly sessions",
                icon: <MedicalIcon color="secondary" />,
              },
              {
                name: "Diet Plan",
